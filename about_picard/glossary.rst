...
**acoustic fingerprint**
   ...
   An :index:`acoustic fingerprint <acoustic fingerprint, fingerprint; acoustic>` is a digital summary of an audio signal, that can be used to
...
**artist credit**
   ...
   An :index:`artist credit` indicates who is the main credited artist (or artists) for releases, release
...
**recording**
   ...
   associated with a single :index:`recording`, but a recording can be linked to any number of tracks.
...
**standalone recording**
   ...
   A :index:`recording <recording; standalone, standalone recording>` that is not linked to any release. An example is "`Sea of No Cares (live)
...
**work**
   ...
   :index:`A distinct intellectual or artistic creation <work>`, which can be expressed in the form of
