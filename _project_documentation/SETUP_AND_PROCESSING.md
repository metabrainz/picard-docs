...
- `_project_documentation`: This directory contains the documentation files describing and supporting the project. It does not contain the actual Picard documentation.
...
- **Repository URL**: https://github.com/metabrainz/picard-docs
...
5. Once the production (non-beta) version of Picard is publicly released, a new `v{major}.{minor}` branch should be created from the `main` branch, and pushed to the git repository, which will add the new version to the list of available versions on ReadTheDocs.
