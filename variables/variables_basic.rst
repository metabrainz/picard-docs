...
**_albumartists**
   ...
   As of Picard 3.0 this variable has been promoted to a tag, and this new tag should be used in scripting as ``%albumartists%``. This variable has been retained for backwards compatibility.
...
**_albumartists_comments**
    ...
    Multi-value list of the disambiguation comments for all credited album artists (one per artist, in order). (*since Picard 3.0*)
...
**_artistcomment**
   ...
   The disambiguation comment for the track artist. Only set for single-artist credits, empty for collaborations. (*since Picard 3.0*)

**_artists_comments**

    Multi-value list of the disambiguation comments for all credited track artists (one per artist, in order). (*since Picard 3.0*)
