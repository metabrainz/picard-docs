...
If a tag description indicates a later version of Picard than the current official version on the downloads page, then the tag is beta functionality which will be available in the next official release. A description of how to gain access to these beta versions for testing can be found on the `Picard downloads page <https://picard.musicbrainz.org/downloads/>`_ on the website.
