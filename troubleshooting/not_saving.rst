...
**After selecting files in the right-hand pane you see a red stop like icon**
   ...
   Another possibility is that the total length of the destination path and file name exceeds the maximum length allowed by the operating system. If you have an extremely long path and file name, try shortening it to see it it allows the file to be saved.
