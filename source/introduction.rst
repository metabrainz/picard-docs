...
.. only:: html
   ...
   The :doc:`Picard Tag Mappings <technical/tag_mapping>` section provides more information
   regarding the mapping between Picard internal tag names and various tagging formats.

.. only:: latex

   The :doc:`Picard Tag Mappings <technical/tag_mapping_pdf>` section provides more information
   regarding the mapping between Picard internal tag names and various tagging formats.
